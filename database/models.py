...
class KnowledgeDocument(BasicModel):
    ...
    # Per-page OCR/extraction snapshot (markdown, layout, table HTML,
    # confidence, bounding boxes) — lets future work reuse OCR output without
    # re-running it. See extraction.base.ExtractedDocument.to_page_records().
    extracted_pages: Mapped[Optional[list[dict]]] = mapped_column(JSONB, nullable=True)
